      ...
      <div className="about-content">
        ...
        <div className="row about__content-details-row">
          <div className="col-12 col-lg-6 col-md-12">
            ...
            <p>
            I worked as a MERN stack developer at <b>FindHer</b>, where my primary tasks included designing and implementing backend APIs, creating responsive and user-friendly front-end interfaces, and ensuring the security and performance of the applications.
            </p>
          </div>
